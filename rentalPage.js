...
xhr.open('GET', 'api/bedroom.php?action=list');
    ...
    if (xhr.readyState == 4 && xhr.status == 200) {
        ...
        if (res.code == 0) {
            ...
            for (var i = 0; i < res.data.length; i++) {
                ...
                str += '<li style="margin-right:40px">\n<form action="./api/myrentals.php"  name="myrental" method="post">' +
                    ...
                    '<input type="submit" class="btn btn-dark d-flex mx-auto justify-content-center" name="property" value="Rent for $' + res.data[i].rent + '">' +
